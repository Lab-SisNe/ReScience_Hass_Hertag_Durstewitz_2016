...
ISImean = ISImean_list[0]
ISICV = ISICV_list[0]

lag = lag_array_list[0]
correlation = correlation_mean_list[0]

autocorr = autocorrvalue_list[0]
autot = autocorrt_list[0]
