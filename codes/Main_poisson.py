...
if control_param['run']:
    ...
    fig, ax = cortex.raster_plot(tlims=[pulse1-100, pulse1+400], save=False, figuresize=(12,10), plotsize=7)
    plt.sca(ax)
    ...
    fig, ax = cortex.raster_plot(tlims=[pulse2-100, pulse2+400], save=False, figuresize=(12,10), plotsize=7)
    plt.sca(ax)
