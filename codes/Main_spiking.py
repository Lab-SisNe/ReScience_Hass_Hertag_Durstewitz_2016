...
cortex.neuron_params([ratestratification_neuron_list[0][0]])
cortex.neuron_params([ratestratification_neuron_list[0][1]])
cortex.neuron_params([ratestratification_neuron_list[1][0]])
cortex.neuron_params([ratestratification_neuron_list[1][1]])

cortex.neuron_mw_test(ratestratification_neuron_list[0][0],ratestratification_neuron_list[0][1])
cortex.neuron_mw_test(ratestratification_neuron_list[1][0],ratestratification_neuron_list[1][1])

cortex.synapses_mw_test(ratestratification_neuron_list[0][0],ratestratification_neuron_list[0][1])
cortex.synapses_mw_test(ratestratification_neuron_list[1][0],ratestratification_neuron_list[1][1])

cortex.connection_chi(ratestratification_neuron_list[0][0],ratestratification_neuron_list[0][1])
cortex.connection_chi(ratestratification_neuron_list[0][0],ratestratification_neuron_list[0][1], synapses_type='inhibitory')
cortex.connection_chi(ratestratification_neuron_list[0][0],ratestratification_neuron_list[0][1], synapses_type='excitatory')

cortex.connection_chi(ratestratification_neuron_list[1][0],ratestratification_neuron_list[1][1])
cortex.connection_chi(ratestratification_neuron_list[1][0],ratestratification_neuron_list[1][1], synapses_type='inhibitory')
cortex.connection_chi(ratestratification_neuron_list[1][0],ratestratification_neuron_list[1][1], synapses_type='excitatory')
