...
# constant_current = [[250, 200, 200, 200, 200, 200, 200, 250, 200, 200, 200, 200, 200, 200] for i in range(control_param['Stripes'])
#                     ]
...
RegularStimuli = [
                ...
                # [1, 1, 500, 0.08, 0, 2500, 2505, [[0, 0, 0.1],],],
                ]      
...
analysis_params['ISI'] = {
                            ...
                            #               'Minimum spike number': 11
                            #               },
                            # 'Analysis 8': {'Group': [['PC_L5', 0],],
                            #               'Start': start,
                            #               'Stop': stop,
                            #               'Time bin': 2,
                            #               'Minimum spike number': 11
                            #               },
                            # 'Analysis 9': {'Group': [['PC', 0],],
                            #               'Start': start,
                            #               'Stop': stop,
                            #               'Time bin': 2,
                            #               'Minimum spike number': 11
...
analysis_params['V'] = {
                        ...
                        #                   'Minimum spike number': 0,
                        #                 },
                        # 'Analysis 4': {'Group': [['PC', 0,],],
                        #                 'Start': 0,
                        #                 'Stop': 1000,
                        #                 'Minimum spike number': 0,
                        #                     },
                        # 'Analysis 5': {'Group': [['all', 0,],],
                        #                   'Start': 0,
                        #                   'Stop': stop,
                        #                   'Minimum spike number': 11,
                        #                 },
                        # 'Analysis 6': {'Group': [['PC_L23', 0,],],
                        #                 'Start': 0,
                        #                 'Stop': 1000,
                        #                 'Minimum spike number': 11,
                        #                     },
                        # 'Analysis 7': {'Group': [['PC_L5', 0,],],
                        #                   'Start': 0,
                        #                   'Stop': stop,
                        #                   'Minimum spike number': 11,
                        #                 },
                        # 'Analysis 8': {'Group': [['PC', 0,],],
                        #                 'Start': 0,
                        #                 'Stop': 1000,
                        #                 'Minimum spike number': 11,
                        #                     },
...
analysis_params['Populational rate'] = {
                                           ...
                                           #               },
                                              ...
                                              #               'Moving average': 31
                                              #               },
                                           #   'Analysis 3': {'Group': [['IN_L_d_L23', 0],],
                                           #                 'Start': start,
                                           #                 'Stop': stop,
                                           #                 'Time bin': 1,
                                           #                 'Moving average': 101
                                           #                 },
                                           #   'Analysis 4': {'Group': [['IN_CL_L23', 0],],
                                           #                 'Start': start,
                                           #                 'Stop': stop,
                                           #                 'Time bin': 1,
                                           #                 'Moving average': 101
                                           #                 },
                                           #   'Analysis 5': {'Group': [['IN_CL_AC_L23', 0],],
                                           #                 'Start': start,
                                           #                 'Stop': stop,
                                           #                 'Time bin': 1,
                                           #                 'Moving average': 101
                                           #                 },
                                           #   'Analysis 6': {'Group': [['IN_CC_L23', 0],],
                                           #                 'Start': start,
                                           #                 'Stop': stop,
                                           #                 'Time bin': 1,
                                           #                 'Moving average': 101
                                           #                 },
                                           #   'Analysis 7': {'Group': [['IN_F_L23', 0],],
                                           #                 'Start': start,
                                           #                 'Stop': stop,
                                           #                 'Time bin': 1,
                                           #                 'Moving average': 101
                                           ...
                                           #                 'Moving average': 31,
                                           #                 },
                                           #   'Analysis 9': {'Group': [['IN_L_L5', 0],],
                                           #                 'Start': start,
                                           #                 'Stop': stop,
                                           #                 'Time bin': 1,
                                           #                 'Moving average': 101
                                           #                 },
                                           #   'Analysis 10': {'Group': [['IN_L_d_L5', 0],],
                                           #                 'Start': start,
                                           #                 'Stop': stop,
                                           #                 'Time bin': 1,
                                           #                 'Moving average': 101
                                           #                 },
                                           #   'Analysis 11': {'Group': [['IN_CL_L5', 0],],
                                           #                 'Start': start,
                                           #                 'Stop': stop,
                                           #                 'Time bin': 1,
                                           #                 'Moving average': 101
                                           #                 },
                                           #   'Analysis 12': {'Group': [['IN_CL_AC_L5', 0],],
                                           #                 'Start': start,
                                           #                 'Stop': stop,
                                           #                 'Time bin': 1,
                                           #                 'Moving average': 101
                                           #                 },
                                           #   'Analysis 13': {'Group': [['IN_CC_L5', 0],],
                                           #                 'Start': start,
                                           #                 'Stop': stop,
                                           #                 'Time bin': 1,
                                           #                 'Moving average': 101
                                           #                 },
                                           #   'Analysis 14': {'Group': [['IN_F_L5', 0],],
                                           #                 'Start': start,
                                           #                 'Stop': stop,
                                           #                 'Time bin': 1,
                                           #                 'Moving average': 101
...
if control_param['run']:
    ...
    if len(analysis_params['ISI'].values()) + len(analysis_params['V'].values()) + len(analysis_params['Frequence'].values()) + len(analysis_params['Populational rate'].values()) + len(analysis_params['Rate distribution'].values()) + len(analysis_params['DAcorrelation'].values()) :
        ...
        if len(analysis_params['V'].values()):
            monitor_t,Vindividualstd_list, Vindividualmean_list, Vgroup_list, VzerolagCC_list, VnormalizedzerolagCC_list = cortex.V_analysis(analysis_params['V'].values(), simulation_dir)
    ...
    # final_t = np.where((cortex.spikemonitor.t/ms >= 995) & (cortex.spikemonitor.t/ms < 1195))[0]
    # fig, ax = subplots()
    # ax.scatter(cortex.spikemonitor.t[final_t]/ms, cortex.spikemonitor.i[final_t], 1)
    # ax.set_xlabel('t (ms)')
    # ax.set_ylabel('neuron index')
    # fig.savefig('{}/rasterplot1.png'.format(simulation_dir))
    
    # final_t = np.where((cortex.spikemonitor.t/ms >= 950) & (cortex.spikemonitor.t/ms < 1450))[0]
    # fig, ax = subplots()
    # ax.scatter(cortex.spikemonitor.t[final_t]/ms, cortex.spikemonitor.i[final_t], 1)
    # ax.set_xlabel('t (ms)')
    # ax.set_ylabel('neuron index')
    # fig.savefig('{}/rasterplot2.png'.format(simulation_dir))
    
    # final_t = np.where((cortex.spikemonitor.t/ms >= 2495) & (cortex.spikemonitor.t/ms < 2695))[0]
    # fig, ax = subplots()
    # ax.scatter(cortex.spikemonitor.t[final_t]/ms, cortex.spikemonitor.i[final_t], 1)
    # ax.set_xlabel('t (ms)')
    # ax.set_ylabel('neuron index')
    # fig.savefig('{}/rasterplot3.png'.format(simulation_dir))
    
    # final_t = np.where((cortex.spikemonitor.t/ms >= 2450) & (cortex.spikemonitor.t/ms < 2950))[0]
    # fig, ax = subplots()
    # ax.scatter(cortex.spikemonitor.t[final_t]/ms, cortex.spikemonitor.i[final_t], 1)
    # ax.set_xlabel('t (ms)')
    # ax.set_ylabel('neuron index')
    # fig.savefig('{}/rasterplot4.png'.format(simulation_dir))
    

    # final_t = np.where((cortex.spikemonitor.t/ms >= 1450) & (cortex.spikemonitor.t/ms < 1850))[0]
    # fig, ax = subplots()
    # ax.scatter(cortex.spikemonitor.t[final_t]/ms, cortex.spikemonitor.i[final_t], 1)
    # fig.savefig('{}/rasterplot7.png'.format(simulation_dir))  

    
###############----------||| Parameters summary |||----------###############
# GroupSetup = [[['all', 0]], [['PC_L23',0]],[['PC_L5',0]],
#               [[1,0], [2,0], [8, 0], [9,0]],
#               [[3,0], [4,0], [10,0], [11,0]],
#               [[5,0], [12,0]],
#               [[6,0], [13,0]],
...
# cortex.synapses_params([[[ratedistribution_neuron_list[0][0], 'all']]], simulation_dir, neuron_index=True)
# cortex.synapses_params([[[ratedistribution_neuron_list[0][1], 'all']]], simulation_dir, neuron_index=True)
# cortex.synapses_params([[[ratedistribution_neuron_list[1][0], 'all']]], simulation_dir, neuron_index=True)
# cortex.synapses_params([[[ratedistribution_neuron_list[1][1], 'all']]], simulation_dir, neuron_index=True)
# cortex.synapses_params([[[ratedistribution_neuron_list[2][0], 'all']]], simulation_dir, neuron_index=True)
# cortex.synapses_params([[[ratedistribution_neuron_list[2][1], 'all']]], simulation_dir, neuron_index=True)
# cortex.synapses_params([[[ratedistribution_neuron_list[3][0], 'all']]], simulation_dir, neuron_index=True)
# cortex.synapses_params([[[ratedistribution_neuron_list[3][1], 'all']]], simulation_dir, neuron_index=True)

# cortex.synapses_params([[['all', ratedistribution_neuron_list[0][0]]]], simulation_dir, neuron_index=True)
# cortex.synapses_params([[['all', ratedistribution_neuron_list[0][1]]]], simulation_dir, neuron_index=True)
# cortex.synapses_params([[['all', ratedistribution_neuron_list[1][0]]]], simulation_dir, neuron_index=True)
# cortex.synapses_params([[['all', ratedistribution_neuron_list[1][1]]]], simulation_dir, neuron_index=True)
# cortex.synapses_params([[['all', ratedistribution_neuron_list[2][0]]]], simulation_dir, neuron_index=True)
# cortex.synapses_params([[['all', ratedistribution_neuron_list[2][1]]]], simulation_dir, neuron_index=True)
# cortex.synapses_params([[['all', ratedistribution_neuron_list[3][0]]]], simulation_dir, neuron_index=True)
# cortex.synapses_params([[['all', ratedistribution_neuron_list[3][1]]]], simulation_dir, neuron_index=True)


# cortex.neuron_t_test(ratedistribution_neuron_list[0][0],ratedistribution_neuron_list[0][1], simulation_dir)
# cortex.neuron_t_test(ratedistribution_neuron_list[1][0],ratedistribution_neuron_list[1][1], simulation_dir)
# cortex.neuron_t_test(ratedistribution_neuron_list[2][0],ratedistribution_neuron_list[2][1], simulation_dir)
# cortex.neuron_t_test(ratedistribution_neuron_list[3][0],ratedistribution_neuron_list[3][1], simulation_dir)

# cortex.synapses_t_test(ratedistribution_neuron_list[0][0],ratedistribution_neuron_list[0][1], simulation_dir)
# cortex.synapses_t_test(ratedistribution_neuron_list[1][0],ratedistribution_neuron_list[1][1], simulation_dir)
# cortex.synapses_t_test(ratedistribution_neuron_list[2][0],ratedistribution_neuron_list[2][1], simulation_dir)
# cortex.synapses_t_test(ratedistribution_neuron_list[3][0],ratedistribution_neuron_list[3][1], simulation_dir)

# cortex.synapses_t_test(ratedistribution_neuron_list[0][0],ratedistribution_neuron_list[0][1], simulation_dir, target=False)
# cortex.synapses_t_test(ratedistribution_neuron_list[1][0],ratedistribution_neuron_list[1][1], simulation_dir, target=False)
# cortex.synapses_t_test(ratedistribution_neuron_list[2][0],ratedistribution_neuron_list[2][1], simulation_dir, target=False)
# cortex.synapses_t_test(ratedistribution_neuron_list[3][0],ratedistribution_neuron_list[3][1], simulation_dir, target=False)
...
# cortex.synapses_mw_test(ratedistribution_neuron_list[0][0],ratedistribution_neuron_list[0][1], simulation_dir, target=False)
# cortex.synapses_mw_test(ratedistribution_neuron_list[1][0],ratedistribution_neuron_list[1][1], simulation_dir, target=False)
# cortex.synapses_mw_test(ratedistribution_neuron_list[2][0],ratedistribution_neuron_list[2][1], simulation_dir, target=False)
# cortex.synapses_mw_test(ratedistribution_neuron_list[3][0],ratedistribution_neuron_list[3][1], simulation_dir, target=False)
