...
class CortexNetwork():
    ...
    def Pearson_correlation(self, analysis):
        ...
        for analysand in analysis:  
            ...
            lag_array, correlation_mean = Pearson_correlation_group(spike_group, start_time, stop_time, time_bin, lag0, lag1)
        ...
        for analysand in analysis:
            ...
            if len(neuron_idc) > 0:
                ...
                with open(Rate_file, 'a') as f:
                    ...
                    print('Population overall frequency: {} Hz'.format(round(np.sum(count_arr)/(len(neuron_idc)*duration),2)), file=f)
