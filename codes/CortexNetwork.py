...
class CortexNetwork():
    ...
    def neuron_mw_test(self, pop1, pop2, sim_dir):
        ...
        with open(NPfile, 'a') as f:
            ...
            text+="C\nstatistic: {}, p-value: {}\n\n".format(round(Cmw0, 3), round(Cmw1, 3))
            text+="g_L\nstatistic: {}, p-value: {}\n\n".format(round(g_Lmw0, 3), round(g_Lmw1, 3))
            text+="E_L\nstatistic: {}, p-value: {}\n\n".format(round(E_Lmw0, 3), round(E_Lmw1, 3))
            text+="delta_T\nstatistic: {}, p-value: {}\n\n".format(round(delta_mwt0, 3), round(delta_mwt1, 3))
            text+="V_up\nstatistic: {}, p-value: {}\n\n".format(round(V_upmw0, 3), round(V_upmw1, 3))
            text+="tau_w\nstatistic: {}, p-value: {}\n\n".format(round(tau_wmw0, 3), round(tau_wmw1, 3))
            text+="b\nstatistic: {}, p-value: {}\n\n".format(round(bmw0, 3), round(bmw1, 3))
            text+="V_r\nstatistic: {}, p-value: {}\n\n".format(round(V_rmw0, 3), round(V_rmw1, 3))
            text+="V_T\nstatistic: {}, p-value: {}\n\n".format(round(V_mwt0, 3), round(V_mwt1, 3))
            text+="I_ref\nstatistic: {}, p-value: {}\n\n".format(round(I_refmw0, 3), round(I_refmw1, 3))
            text+="V_dep\nstatistic: {}, p-value: {}\n\n".format(round(V_depmw0, 3), round(V_depmw1, 3))
            text+="tau_m\nstatistic: {}, p-value: {}\n\n".format(round(tau_mmw0, 3), round(tau_mmw1, 3))
            text+="I_SN\nstatistic: {}, p-value: {}\n\n".format(round(I_SNmw0, 3), round(I_SNmw1, 3))
    ...
    def synapses_mw_test(self, pop1, pop2, sim_dir, target=True):
        ...
        if len(AMPA_idc1)*len(AMPA_idc2) > 0:
            ...
            with open(NPfile, 'a') as f:
              ...
              text += "U\nstatistic: {}, p-value: {}\n\n".format(round(usemw1, 3), round(usemw2, 3))
              text += "tau_rec\nstatistic: {}, p-value: {}\n\n".format(round(tau_recmw1, 3), round(tau_recmw2, 3))
              text += "tau_fac\nstatistic: {}, p-value: {}\n\n".format(round(tau_facmw1, 3), round(tau_facmw2, 3))
              text += "g_max\nstatistic: {}, p-value: {}\n\n".format(round(g_maxmw1, 3), round(g_maxmw2, 3))
              text += "dtax\nstatistic: {}, p-value: {}\n\n".format(round(dtaxmw1, 3), round(dtaxmw2, 3))
    ...
    def V_analysis(self, analysis, sim_dir):
        ...
        for analysand in analysis:
            ...
            fig.savefig('{}/V_analysis/V_group_{}.png'.format(sim_dir, curr_idc))
            ...
            ax.set_ylabel('Number of pairs')
            fig.savefig('{}/V_analysis/V_curr_{}.png'.format(sim_dir, curr_idc))
            
            fig, ax = subplots()
            ax.hist(V_corr, bins=bins_lims, density=True)
            ax.set_xlabel('Zero-lag cross-correlation (mV^2)')
            ax.set_ylabel('Density')
            fig.savefig('{}/V_analysis/V_currdens_{}.png'.format(sim_dir, curr_idc))
            
            fig, ax = subplots()
            ax.plot(dens_lims, dens_arr)
            ax.set_xlabel('Zero-lag cross-correlation (mV^2)')
            ax.set_ylabel('Density')
            fig.savefig('{}/V_analysis/V_currplot_{}.png'.format(sim_dir, curr_idc))
            ...
            fig.savefig('{}/V_analysis/V_currplot1_{}.png'.format(sim_dir, curr_idc))
            ...
            fig.savefig('{}/V_analysis/V_currplot2_{}.png'.format(sim_dir, curr_idc))
            ...
            fig.savefig('{}/V_analysis/V_norm_curr_{}.png'.format(sim_dir, curr_idc))
            
            fig, ax = subplots()
            ax.set_xlabel('Zero-lag cross-correlation')
            ax.set_ylabel('Density')
            ax.hist(V_norm_corr, bins=bins_lims, density=True)
            fig.savefig('{}/V_analysis/V_norm_currdens_{}.png'.format(sim_dir, curr_idc))
            
            fig, ax = subplots()
            ax.set_xlabel('Zero-lag cross-correlation')
            ax.set_ylabel('Density')
            ax.plot(dens_lims, dens_arr)
            fig.savefig('{}/V_analysis/V_norm_currplot_{}.png'.format(sim_dir, curr_idc))
            ...
            ax.plot(dens_lims, dens_arr)
            fig.savefig('{}/V_analysis/V_norm_currplot1_{}.png'.format(sim_dir, curr_idc))
            ...
            ax.plot(dens_lims, dens_arr)
            fig.savefig('{}/V_analysis/V_norm_currplot2_{}.png'.format(sim_dir, curr_idc))
            ...
            fig.savefig('{}/V_analysis/Vstd_{}.png'.format(sim_dir, curr_idc))
            
            fig, ax = subplots()
            ax.set_xlabel('V standard deviation (mV)')
            ax.set_ylabel('Density')
            ax.hist(Vstd_arr, bins=bins_lims, density=True)
            fig.savefig('{}/V_analysis/Vstddens_{}.png'.format(sim_dir, curr_idc))
            
            fig, ax = subplots()
            ax.set_xlabel('V standard deviation (mV)')
            ax.set_ylabel('Density')
            ax.plot(dens_lims, dens_arr)
            fig.savefig('{}/V_analysis/Vstdplot_{}.png'.format(sim_dir, curr_idc))
            ...
            fig.savefig('{}/V_analysis/Vstdplot0_{}.png'.format(sim_dir, curr_idc))
            ...
            fig.savefig('{}/V_analysis/Vstdplot1_{}.png'.format(sim_dir, curr_idc))
            ...
            fig.savefig('{}/V_analysis/Vstdplot2_{}.png'.format(sim_dir, curr_idc))
