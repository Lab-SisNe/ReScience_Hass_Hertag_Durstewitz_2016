...
for memb_variability in np.arange(0, 1.1, 0.1):
    ...
    param_std_scale = np.ones((10, 14)) * memb_variability# Scale of std of membrane parameters for each group
    ...
    RegularStimuli = [
                    [1, 1, 250, 0.08, 0, 1000, 1005, [[0, 0, 0.1],],],                
    ...
    if control_param['run']:
        ...
        stim_on1 = 1000
        stim_on2 = 2500
        cortex.raster_plot(simulation_dir, tlims=[stim_on1-5, stim_on1+45])
        cortex.raster_plot(simulation_dir, tlims=[stim_on1-10, stim_on1+90])
        cortex.raster_plot(simulation_dir, tlims=[stim_on1-50, stim_on1+150])
        cortex.raster_plot(simulation_dir, tlims=[stim_on1-50, stim_on1+250])
        cortex.raster_plot(simulation_dir, tlims=[stim_on1-100, stim_on1+400])
        
        cortex.raster_plot(simulation_dir, tlims=[stim_on2-5, stim_on2+45])
        cortex.raster_plot(simulation_dir, tlims=[stim_on2-10, stim_on2+90])
        cortex.raster_plot(simulation_dir, tlims=[stim_on2-50, stim_on2+150])
        cortex.raster_plot(simulation_dir, tlims=[stim_on2-50, stim_on2+250])
        cortex.raster_plot(simulation_dir, tlims=[stim_on2-100, stim_on2+400])
